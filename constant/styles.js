...
export const Fonts = {
    ...
    primaryColor24Bold: { fontFamily: 'NotoSans_Bold', color: '#6979F8', fontSize: 24.0 },

    primaryColorBold: { fontFamily: 'NotoSans_Bold', color: '#6979F8' },

    orangeColorBold: { fontFamily: 'NotoSans_Bold', color: '#FF9B07' },
    orangeColorBold18Bold: { fontFamily: 'NotoSans_Bold', color: '#FF9B07',fontSize: 18.0 },
    orangeColorBold18Regular: { fontFamily: 'NotoSans_Regular', color: '#FF9B07',fontSize: 18.0 },
